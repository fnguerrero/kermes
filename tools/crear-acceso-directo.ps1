# Deja el acceso directo de Kermés en el Escritorio.
#
...
$icono = Join-Path $raiz 'kermes.ico'
...
$destino = Join-Path ([Environment]::GetFolderPath('Desktop')) 'Kermes.lnk'
...
$lnk.Description      = 'Kermes - una noche en el baldio'
$lnk.Save()
